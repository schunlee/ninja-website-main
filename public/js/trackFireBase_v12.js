let Track = (function () {
    ...
    const measurement_id = `G-RX8350PBT0`;
    const api_secret = `vaY6jo-KTKG2vTW3hc8cSA`;
    let _gClientId = '';
    function TrackCtor() {
    ...
    _proto.copyToClipboard=function(text){
        if (navigator) {
            ...
            return Promise.resolve("not found  navigator");
        }
    }
    ...
    _proto.commit = function (adurl,gclid) {
        if (!gclid) return Promise.resolve({});
        var msg = { adurl: adurl,gclid: gclid}
